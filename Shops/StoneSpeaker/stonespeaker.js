...
const loadDataLowToHigh = async () => {
  ...
  try {
    const res = await fetch(
      'https://boatdatabase.herokuapp.com/stone?_sort=price&_order=asc'
    )
    data = await res.json()
...
const loadDataHighToLow = async () => {
  try {
    const res = await fetch(
      'https://boatdatabase.herokuapp.com/stone?_sort=price&_order=desc'
    )
    data = await res.json()
    displayCharacters(data)
  } catch (err) {
...
const loadData = async () => {
  try {
    const res = await fetch('https://boatdatabase.herokuapp.com/stone')
    data = await res.json()
    displayCharacters(data)
  } catch (err) {
    console.error(err)
